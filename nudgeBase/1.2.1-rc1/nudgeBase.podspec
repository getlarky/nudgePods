...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => 'https://github.com/getlarky/nudgePods/releases/download/nudgeBase-1.2.1-rc1/nudgeBase.zip'}
 ...
 # s.default_subspecs = 'EnvironmentUtils', 'KeyValueStore', 'NudgeAnalytics', 'NudgeBase'
  ...
  s.dependency 'KeyValueStore', '1.0.0'
  s.dependency 'NudgeAnalytics', '1.0.0'
