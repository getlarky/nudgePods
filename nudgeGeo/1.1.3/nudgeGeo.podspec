...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => 'https://github.com/getlarky/nudgePods/releases/download/nudgeGeo-1.1.3/nudgeGeo.zip'}
  ...
  # s.dependency 'FirebaseMessaging', '11.5.0'
  # s.dependency 'Analytics', '4.1.2'
  s.dependency 'nudgeBase', '1.2.3'
end
